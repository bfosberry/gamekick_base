...
# install etcdctl
RUN wget https://github.com/coreos/etcd/releases/download/v0.4.4/etcd-v0.4.4-linux-amd64.tar.gz
RUN tar -xzf etcd-v0.4.4-linux-amd64.tar.gz
RUN mv etcd-v0.4.4-linux-amd64 /opt/etcd
